...
- "event_create": el secretario quiere agendar algo — en cualquier forma gramatical y aunque falte la fecha. Formas válidas: imperativas ("agendá reunión con EANA el martes a las 10", "programá una movilización para el viernes", "agenda que mañana 13:30 tenemos reunión con X", "agenda esto para el jueves"), interrogativas ("¿Podés agendar una reunión?", "¿Me agendás algo para el jueves?"), afirmativas ("quiero agendar una reunión", "necesito programar una reunión con EANA"). CLAVE: "agenda que [fecha/hora/evento]" es SIEMPRE event_create (imperativo rioplatense de "agendar"), NUNCA "report". Si el mensaje comienza con "agenda" o "agendá" seguido de una fecha, hora o descripción de evento → event_create. La mención de "reunión" o "movilización" NO alcanza para ser reporte si el mensaje contiene una instrucción de agendar.
