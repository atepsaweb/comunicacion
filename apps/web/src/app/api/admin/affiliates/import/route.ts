...
const COLUMN_MAP: Record<string, keyof AffiliateInput> = {
  // Nombre y apellido
  apellido: 'last_name',    apellidos: 'last_name',
  'last name': 'last_name', last_name: 'last_name',  surname: 'last_name',
  nombre: 'first_name',     nombres: 'first_name',
  'first name': 'first_name', first_name: 'first_name', given_name: 'first_name',
  // Nuevos campos específicos de delegados
  aeropuerto: 'aeropuerto', airport: 'aeropuerto',
  organismo: 'organismo',   organism: 'organismo',
  rama: 'rama',             branch: 'rama',
  tipo: 'tipo',             type: 'tipo',
  vigencia: 'vigencia',     mandato: 'vigencia',      vencimiento: 'vigencia',
  // Campos legacy (siguen funcionando)
  dependencia: 'dependency', dependency: 'dependency',
  estacion: 'dependency',
  gerencia: 'dependency',    sector: 'dependency',
  area: 'dependency',        área: 'dependency',
  cargo: 'position',         posicion: 'position',
  posición: 'position',      position: 'position',    rol: 'position',
  // Otros
  dni: 'dni',                documento: 'dni',
  legajo: 'legajo',
  email: 'email',            correo: 'email',
  telefono: 'phone_e164',    teléfono: 'phone_e164',
  phone: 'phone_e164',       whatsapp: 'phone_e164',
